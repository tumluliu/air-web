...
var Directions = L.Class.extend({
    ...
    statics: {
        ...
        ORS_API_TEMPLATE:
            "https://api.openrouteservice.org/plugintest?&coordinates={coordinates}&geometry_format=geojson&instructions=false&preference={preference}&profile={profile}&api_key={token}",
        GOOGLE_API_TEMPLATE:
